...
// Configurando o CORS: https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS
...
void MigrarBaseDeDados(string? connString)
{
    try
    {
        ...
        var evolve = new Evolve(envConn, Log.Information)
        {
...
// Habilitando o uso do CORS (tem que ser colocado nessa parte do código)
app.UseCors();
